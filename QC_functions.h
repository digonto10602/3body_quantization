                        ...
                        int max_shell_num   )
{
    ...
    config_maker_1(p_config2, En, total_P, mi, mj, mk, L, epsilon_h, config_tolerance );
    ...
    //F2_mat <<   F2_mat_1,                   Eigen::MatrixXcd::Zero(size1,size2),
    //            Eigen::MatrixXcd::Zero(size2,size1), F2_mat_2; 
    ...
    K2inv_mat   <<  K2inv_mat_1,                        Eigen::MatrixXcd::Zero(size1,size2),
                    Eigen::MatrixXcd::Zero(size2,size1),  2.0*K2inv_mat_2;

    Eigen::MatrixXcd G_mat(size1 + size2,size1 + size2);

    G_mat  <<   G_mat_11,                  std::sqrt(2.0)*G_mat_12,
                std::sqrt(2.0)*G_mat_21,   Eigen::MatrixXcd::Zero(size2,size2);
